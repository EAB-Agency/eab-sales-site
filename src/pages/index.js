      ...
      <Layout location={this.props.location}>
        ...
        <header className="content-header">
          ...
          <div className="page-title-container">
            ...
            <div className="breadcrumb">
              <p>
                Univertisy Home / Academics / Programs / Physician Assistant
              </p>
            </div>
          </div>
        </header>
        ...
        <section className="page-description wrapper cols">
          <div className="col-70">
            ...
            <p>
              ...
              trains competent, caring medical professionals who are dedicated
              to improving health care quality and outcomes. Through clinical
        ...
        <section className="page-content wrapper cols">
          <div className="col-60">
            ...
            <p>
              ...
              tests to treating minor injuries. While a P.A. usually works with
              a supervising physician, they can function as a primary care
              physician in some more rural areas.
            </p>
            <p>
              ...
              professionals that provide competent, compassionate care. As a
              P.A. you can make a real difference in the lives of patients of
        ...
        <section className="grey-section">
          <div className="wrapper">
            ...
            <p>
              ...
              prescribed 4-year course of study in any undergraduate major and
              27 months of training in the P.A. program at the College of Health
              Care Sciences.
            </p>
          </div>
        </section>
        ...
        <section className="grey-section">
          <div className="wrapper">
            ...
            <p>
              ...
              must meet. <strong>Undergraduate Admission Requirements</strong>{' '}
              are for first-time and transfer students applying to earn a
              bachelor’s degree.{' '}
              <strong>Graduate Admission Requirements</strong> are the standards
              students need to maintain while earning their undergraduate degree
        ...
        <section className="blue-section statistics">
          <div className="wrapper">
            ...
            <small>
              ** Anatomy and Physiology, and Living Environment may be
              substituted for Biology.
            </small>
          </div>
        </section>
          ...
          <div className="wrapper cols">
            <div className="col-50">
              ...
              <div className="group checkmarked">
                ...
                <p>
                  {' '}
                  You must maintain a <strong> 3.2</strong> cumulative and
                  science GPA.You must also earn at least a C in each
                  prerequisite course.
                </p>
              </div>
            </div>
            <div className="col-50">
              <div className="group checkmarked">
                ...
                <p>
                  ...
                  the verbal reasoning and quantitative reasoning sections, and
                  no less than a <strong> 4.0</strong> on analytical writing.{' '}
                  <small>
