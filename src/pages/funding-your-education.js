        ...
        <header className="content-header">
          ...
          <div className="page-title-container">
            ...
            <div className="breadcrumb">
              <p>Univertisy Home / Fundint Your Education</p>
            </div>
          </div>
        </header>
        ...
        <section className="page-description wrapper cols">
          <div className="col-70">
            ...
            <p>
              ...
              future. At CoA, you’ll get a world-class education for an
              affordable price. You’ll also build industry connections and gain
              hands-on experience that will give you an edge in today’s
            ...
            <p>
              ...
              your education so you can reap the full value of your CoA degree
              and earn a competitive advantage in your career, community and
              life.
            </p>
            <p>
            ...
            <div className="col-50">
              <div className="group">
                ...
                <p>
                  ...
                  sure you’re considered for the maximum potential amount of
                  aid. Remember to include our FAFSA code,{' '}
                  <strong>000000</strong>, so that CoA receives your
                  information—we’ll send you an email confirmation with next
                  steps once we do.
                </p>
                <p>
                  It’s easier than ever to file your FAFSA. The U.S. Department
                  of Education redesigned its website to make it mobile-friendly
                  and also introduced a new smartphone application called{' '}
              ...
              <div className="group">
                <div className="video-container">
                  <iframe
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/LK0bbu0y5AM"
                    frameBorder="0"
            ...
            <div className="col-50">
              <div className="group">
                ...
                <p>
                  ...
                  apply, so we encourage you to review CoA’s State Aid
              ...
              <div className="group">
                ...
                <p>
                  Merit- and need-based opportunities are available for
                  residents.
                </p>
                <p>
            ...
            <div className="col-60">
              <div className="wrapper">
                <div className="group">
                  <h4>Scholarships</h4>
                  <p>
                    Scholarships are one of the best ways to pay for your
                    college education. They don’t cost you anything, you don’t
                    have to pay them back and some are considered prestigious
                    honors that you can reference on your resume. College of
                    America offers both need- and merit-based scholarships, and
                    our friendly staff is available to help you find private
                    scholarships to supplement your financial aid package if
                    needed.
                  </p>
                  <p>
                ...
                <div className="group">
                  ...
                  <p>
                    ...
                    need-based employment programs, such as Federal Work-Study,
                    or non-need-based programs, such as the Student Employment
